...
/* JADX INFO: renamed from: com.mascotcapsule.eruption.docomostar.t */
/* JADX INFO: loaded from: C:\Temp\jadx-6661938794004345591\classes.dex */
final class C0121t extends AbstractC0067cl {
    C0121t() {
    }
    ...
    final void mo456a(Transform transform, float[] fArr) {
        ...
        fArr2[4] = ((-fSin3) * fCos2) + (fCos3 * fSin * fSin2);
        fArr2[8] = fCos * fSin2;
        fArr2[1] = fSin3 * fCos;
        fArr2[5] = fCos3 * fCos;
        fArr2[9] = -fSin;
        fArr2[2] = ((-fCos3) * fSin2) + (fSin3 * fSin * fCos2);
        fArr2[6] = (fSin * fCos3 * fCos2) + (fSin2 * fSin3);
        fArr2[10] = fCos * fCos2;
    ...
    final void mo457b(Transform transform, float[] fArr) {
        ...
        if (f == 0.5f || f == -0.5f) {
            ...
            fArr[2] = Util3D.asin(fArr2[1] / Util3D.cos(f));
            if (fArr2[5] < 0.0f) {
                fArr[2] = 0.5f - fArr[2];
            }
        }
